...
function Header({ isMobile, onToggle, headerRef, dashboard = "member" }) {
  ...
  const DASHBOARDS = {
    member: { label: "Member Dashboard", home: "/home" },
    temporary: { label: "Temporary Savings", home: "/temporary/home" },
    admin: { label: "Admin Dashboard", home: "/admin/home" },
  };

  const { label: currentLabel = "Member Dashboard", home: currentHome = "/home" } =
