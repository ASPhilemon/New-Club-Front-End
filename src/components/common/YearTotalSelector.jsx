...
function YearTotalSelector({ selectedYear, total, years, onYearChange }) {
  ...
  return (
    <div style={{ position: "relative" }} ref={containerRef}>
      ...
      >
        <span style={{ padding: "2px 0", whiteSpace: "nowrap", color: colors.gold, }}>{selectedYear}</span>
        <span style={{ display: "flex", alignItems: "center", whiteSpace: "nowrap", color: colors.gold, }}>
          {total}
          <span
            style={{
              marginLeft: 12,
              ...
              color: colors.gold, // Ensure icon matches text color
            }}
          >
